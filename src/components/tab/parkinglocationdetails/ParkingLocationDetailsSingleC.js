...
function LocationDetailsSingleC() {
    ...
    return (
        <>
            <div >
                ...
                {parkings.filter(parking => parking.parkeerlocatie.title.includes("Museumplein")).map((filteredParking, index) => {
                    return (
...
export default LocationDetailsSingleC;
